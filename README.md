...
The product UI supports recursive local folder paths, native local file/folder pickers, live run events, matter/chat trace listing, per-message cost, and matter-level cost totals.
