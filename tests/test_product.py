...
class ProductMatterTests(unittest.TestCase):
    ...
    def test_product_ui_renders_answer_markdown_online(self) -> None:
        ...
        self.assertIn("Investigation Map", INDEX_HTML)
        self.assertIn('id="investigationMap"', INDEX_HTML)
        self.assertIn("function renderInvestigationMap", INDEX_HTML)
        self.assertIn("What Irys is answering", INDEX_HTML)
        self.assertIn("Evidence came from:", INDEX_HTML)
        self.assertIn("Worker requested more evidence", INDEX_HTML)
        self.assertIn("function formatEvidenceCoverageForMap", INDEX_HTML)
        self.assertIn("map-action", INDEX_HTML)
